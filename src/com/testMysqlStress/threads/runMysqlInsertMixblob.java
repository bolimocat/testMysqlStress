...
public class runMysqlInsertMixblob implements Runnable{
...
//	private Long interval;
	...
	public runMysqlInsertMixblob(String h,String u,String p,String pt,String db,int n,String insertV,Integer insertN,String file) {
		host = h;
		user = u;
		pass = p;
		port = pt;
