...
public class runMysqlInsertLongblob implements Runnable{
...
//	private Long interval;
	...
	public runMysqlInsertLongblob(String h,String u,String p,String pt,String db,int n,String insertV,Integer insertN,String file) {
		host = h;
		user = u;
		pass = p;
		port = pt;
...
//	controlMySql ctMysql = new controlMySql(host,user,pass,port,database);
	...
	public void run() {
	   ...
	   date.setTime(kit.Time());
		Long time = ctMysqlBlob.insertlongtb(host, user, pass, port, database, tbnum, insertValue,longfile);
